...
public class ZoneMap {
  ...
  public void updateZoomFactor(int count) {
    ...
    double frameWidth =
        (this.frame.width / oldZoomFactor) + Math.ceil(this.offset.width / oldZoomFactor);
    double frameHeight =
        (this.frame.height / oldZoomFactor) + Math.ceil(this.offset.height / oldZoomFactor);
    ...
    this.frame.width =
        (int) ((frameWidth - Math.ceil(this.offset.width / newZoomFactor)) * newZoomFactor);
    this.frame.height =
        (int) ((frameHeight - Math.ceil(this.offset.height / newZoomFactor)) * newZoomFactor);
  ...
  public void draw(Dimension size, Graphics2D graphics) {
    ...
    if (this.doubleBuffer == null || this.offset.width != size.width
