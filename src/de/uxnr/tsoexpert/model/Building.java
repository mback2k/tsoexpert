...
public class Building {
	...
	public Building(BuildingVO buildingVO) {
		this(buildingVO.getBuildingName_string(), new BuildingGridPosition(buildingVO.getBuildingGrid(), buildingVO.getOffsetX(), buildingVO.getOffsetY()), buildingVO.getUpgradeLevel());
	}
