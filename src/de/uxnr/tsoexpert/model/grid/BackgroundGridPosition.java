...
public class BackgroundGridPosition extends GridPosition {
  ...
  public int getY() {
    return (int) ((Math.round(this.position / 34)) * BackgroundGridPosition
        .getBackgroundGridHeight());
  }
  ...
  protected static synchronized int getBackgroundGridHeight() {
    if (BackgroundGridPosition.backgroundGridHeight == null) {
      BackgroundGridPosition.backgroundGridHeight =
          GameSetting
              .getNumber(
                  ((XMLHandler) TSOExpert.getHandler("XMLHandler"))
                      .getDocument(GameSetting.gfx_settings),
                  "//Globals/BackgroundGrid/@h").intValue();
    }
    if (BackgroundGridPosition.backgroundGridHeight != null) {
