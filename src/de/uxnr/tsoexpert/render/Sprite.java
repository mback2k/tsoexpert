      ...
      for (SubtypeCalculated subtypeCalculated : indices.subtypeCalculated_vector) {
        for (FrameCalculated frameCalculated : subtypeCalculated.frameList_vector) {
          if (!frameCalculated.scaled) {
            ...
            frameCalculated.frameOffsXScaledCache =
                Math.floor(frameCalculated.frameOffsXScaled - subtypeCalculated.seqFootXScaled);
            frameCalculated.frameOffsYScaledCache =
                Math.floor(frameCalculated.frameOffsYScaled - subtypeCalculated.seqFootYScaled);
          }
        }
      }
    }
