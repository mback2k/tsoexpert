...
public class GameHandler implements TSOHandler, HostHandler {
  ...
  private final ListMap<Integer, IDataHandler<? extends AMF_Type>> dataHandlers =
      new ListMap<Integer, IDataHandler<? extends AMF_Type>>();
  ...
  private synchronized void parseServerActionResult(Integer type,
      ServerActionResult serverActionResult) throws IOException {
    AMF_Type value = serverActionResult.getData();

    for (Entry<Integer, List<IDataHandler<? extends AMF_Type>>> handler : this.dataHandlers
        .entrySet()) {
  ...
  public synchronized void removeDataHandler(Integer type,
      IDataHandler<? extends AMF_Type> dataHandler) {
